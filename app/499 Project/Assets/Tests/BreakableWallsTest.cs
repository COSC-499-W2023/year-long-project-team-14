...
public class BreakableWallsTest : MonoBehaviour
{
    ...
    public IEnumerator Setup()
    {
        ...
        wall = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Prefabs/BreakableWall.prefab"), new Vector3(0, -5, 0), Quaternion.identity) as GameObject;

        //Spawn player above the wall
        player = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Prefabs/Mage_player1.prefab"), new Vector3(0, 0, 0), Quaternion.identity) as GameObject;
