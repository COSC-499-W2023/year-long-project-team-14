...
public class FireballTest
{
    ...
    public IEnumerator Setup()
    {
        ...
        enemy = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Prefabs/Orc_bonk.prefab"), new Vector3(0, 0, 0), Quaternion.identity) as GameObject;
