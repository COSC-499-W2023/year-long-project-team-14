...
public class MovingWallsTest : MonoBehaviour
{
    ...
    public IEnumerator Setup()
    {
        ...
        wall = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Prefabs/movingWall.prefab")) as GameObject;
        ...
        orc = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Prefabs/Orc_cyan.prefab"), new Vector3(0, 5, 0), Quaternion.identity) as GameObject;
        ...
        player = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Prefabs/Mage_player1.prefab"), new Vector3(0, -5, 0), Quaternion.identity) as GameObject;
